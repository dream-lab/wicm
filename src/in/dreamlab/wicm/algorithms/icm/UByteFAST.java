...
public class UByteFAST extends
        DebugBasicIntervalComputation<IntWritable, UnsignedByte, UnsignedByte, UByteUByteIntervalData, UnsignedByte, UByteUByteIntervalData, UnsignedByte, UnsignedByte, UByteStartSlimMessage> {
