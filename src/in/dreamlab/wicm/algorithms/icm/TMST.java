...
public class TMST extends
        DebugBasicIntervalComputation<IntWritable, Integer, Pair<Integer,Integer>, IntPairIntIntervalData, Integer, IntIntIntervalData, Pair<Integer, Integer>, Pair<Integer, Integer>, IntPairIntIntervalMessage> {
