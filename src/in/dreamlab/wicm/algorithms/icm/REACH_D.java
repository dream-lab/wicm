...
public class REACH_D extends
        DebugBasicIntervalComputation<IntWritable, Integer, Boolean, IntBooleanIntervalData, Boolean, IntBooleanIntervalData, Boolean, Boolean, IntBooleanIntervalMessage> {
