...
public class UByteLD extends
        DebugBasicIntervalComputation<IntWritable, UnsignedByte, Integer, UByteIntIntervalData, Integer, UByteIntIntervalData, Integer, Integer, UByteIntEndSlimMessage> {
