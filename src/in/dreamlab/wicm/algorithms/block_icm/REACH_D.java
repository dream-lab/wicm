...
public class REACH_D extends
        DebugBlockWarpBasicIntervalComputation<IntWritable, Integer, Boolean, IntBooleanIntervalData, Boolean, IntBooleanIntervalData, Boolean, Boolean, IntBooleanIntervalMessage> {
