...
public class REACH_D extends
        DebugBlockWarpBasicIntervalComputation<IntWritable, Integer, Boolean, IntBooleanIntervalData, Integer, IntIntIntervalData, Boolean, Boolean, IntBooleanIntervalMessage> {
