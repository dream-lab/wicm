...
public class UByteFAST extends
        DebugBlockWarpBasicIntervalComputation<IntWritable, UnsignedByte, UnsignedByte, UByteUByteIntervalData, UnsignedByte, UByteUByteIntervalData, UnsignedByte, UnsignedByte, UByteStartSlimMessage> {
