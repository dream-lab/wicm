...
public class TMST extends
        DebugBlockWarpBasicIntervalComputation<IntWritable, Integer, Pair<Integer,Integer>, IntPairIntIntervalData, Integer, IntIntIntervalData, Pair<Integer, Integer>, Pair<Integer, Integer>, IntPairIntIntervalMessage> {
