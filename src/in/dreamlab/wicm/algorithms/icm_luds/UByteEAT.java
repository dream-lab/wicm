...
public class UByteEAT extends
        DebugBlockWarpBasicIntervalComputation<IntWritable, UnsignedByte, Integer, UByteIntIntervalData, Integer, UByteIntIntervalData, Integer, Integer, UByteIntStartSlimMessage> {
