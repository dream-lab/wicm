...
public class UByteIntIdWithValueTextOutputFormat
        extends TextVertexOutputFormat<IntWritable, UByteIntIntervalData, UByteIntIntervalData> {
    ...
    protected class IdWithValueVertexWriter extends TextVertexWriterToEachLine {
        ...
        @Override
        protected Text convertVertexToLine(Vertex<IntWritable, UByteIntIntervalData, UByteIntIntervalData> vertex)
                throws IOException {
